  ...
  return (
    <>
      ...
      <Slideshow label={contentImagesLabel} images={contentImages}>
        <div className={styles['content-padding']}>
          <p>
            A robust module ecosystem was built into our admin CMS to
            accommodate drag and drop content for our publishing team. This
            allowed for pixel perfect design across browsers and devices, and
            helped solidify communication between teams using staging tools like{' '}
            <a
      ...
      <Slideshow label={progressionImagesLabel} images={progressionImages}>
        <div className={styles['content-padding']}>
          <p>
            ...
            across different seasonal Battle Passes, Events, and Challenges. I
            was tasked with building out Halo Infinite and Halo MCC progression.
          </p>
          <p>
            Halo Waypoint’s Infinite Store mimics the in-game store allowing
            players to purchase inventory bundles, currency, boosts, and pieces
            of armor related to customizing their player.{' '}
          </p>
          <p>
            A portal to purchase Xbox GamePass, Halo Infinite, and Halo MCC was
            also implemented.
          </p>
        </div>
      </Slideshow>
      ...
      <Slideshow label={statsImagesLabel} images={statsImages}>
        <div className={styles['content-padding']}>
          <p>
            The Halo Infinite stats section provides players with an interface
            to view previous games and information relating to stats, players,
            and performance.
          </p>
          <p>
      ...
      <Slideshow label={ugcImagesLabel} images={ugcImages}>
        <div className={styles['content-padding']}>
          <p>
            Halo Waypoint&apos;s Infinite Content Browser is a web version of
