  ...
  return (
    <>
      ...
      <div className={styles.skills}>
        <h4>Javascript</h4>
        <p>
          NodeJS, NextJS, React Three Fiber, React, React Native, Typescript,
          Jest testing, Storybook, VueJS, jQuery, lodash, moment, GSAP, Redux
        </p>
      </div>
      <div className={styles.skills}>
        <h4>CSS</h4>
      ...
      <div className={styles.skills}>
        ...
        <p>
          Wordpress, Craft3, ApostropheJS, <br /> Laravel, Magento
        </p>
      </div>
      <div className={styles.skills}>
        <h4>DevOps</h4>
