  ...
  return (
    <>
      ...
      <p>
        ...
        Technological experience ranged from Ruby on Rails in Refinery,
        Javascript ES6 in Apostrophe and VueJS, CSS and SVG animation, Docker
        deployment and Git versioning, and PHP work in custom work and CraftCMS
        / Yii Framework.{' '}
      </p>
      <hr />
